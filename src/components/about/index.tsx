...
export default function AboutSection() {
  return (
    <AboutContainer id='s-about' >

      <div>
        <h1>Sobre( )</h1>
        <p>Olá, meu nome é Thierry Barreto de Castro e tenho 19 anos. Sempre tive contato com tecnologia e nos últimos anos tenho me identificado bastante com essa área, o que me levou a estudar programação. Atualmente, moro em Sardoá-MG e sou um Desenvolvedor de Software Fullstack.</p>
